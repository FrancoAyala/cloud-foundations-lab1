...
Resultado: dev=docker, prod=RDS. Si aparece un requerimiento que requiera control
del SO, se reconsidera postgres-on-EC2 con el costo operativo explícito.
...
— solo cambia el host del secret.git add .
git commit -m "lab-08: postgres tres formas, Secrets Manager, seed.sql, user_data_postgres.sh, decisions 009-010"
git push origin lab-08-franco